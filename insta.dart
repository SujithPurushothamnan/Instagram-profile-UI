        ...
        NestedScrollView(
          headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled)
          {
            return [
              ...
              SliverAppBar(
                expandedHeight: 455,
                pinned: true,//ethu thaan tab aah stable aah vachikuthu scroll aagurappo
                backgroundColor: Colors.black,
...
GestureDetector(
                              ...
                              child: CircleAvatar(
                                ...
                                child: CircleAvatar(
                                  radius: 40,
                                  backgroundImage:
                                      const AssetImage("assets/batman.jpg"),
                                ),
                              ),
                            ),
                            ...
                            Column(
                              children: [
                                Row(
                                  children: [
                             SizedBox(width: 10,),
                                    Text("30",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.white),),
                                    SizedBox(width: 70,),
                                    Text("344",style: TextStyle(fontSize: 18,fontWeight:FontWeight.bold,color: Colors.white),),
                                    SizedBox(width: 50,),
                                    Text("944",style: TextStyle(fontSize: 18,fontWeight:FontWeight.bold,color: Colors.white),),
                                ...
                                Row(
                                  children: [
                                    SizedBox(width: 30,),
                                    Text("posts",style: TextStyle(fontSize: 16,color: Colors.white),),
                                    SizedBox(width: 40,),
                          ...
                          children: [
                            Column(
                              children: [
                                Row(
                                  children: [
                                    Text("Sujith",style: TextStyle(color: Colors.white),),
                                    SizedBox(width: 190,),
                                  ],
                                ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text("SJ",style: TextStyle(color: Colors.white),),
                                    SizedBox(width:210,),
                                  ],
                                ),
                                Row(
                                  children: [
                                    Text("Thanjavur",style: TextStyle(color: Colors.white),),
                                    SizedBox(width: 163,),
                                  ],
                                ),
                                Row(
                                  children: [
                                    ...
                                    Icon(Icons.link,color: Colors.blue.shade100,size: 16,),
                                    Text("gmail.com",style: TextStyle(color: Colors.blue.shade100),),
                                    SizedBox(width:143,),
                                  ],
                                ),
                                SizedBox(height: 10,),
                                ...
                                [
                                 SizedBox(width: 10,),
                                  Icon(CupertinoIcons.play_circle,color: Colors.white,size: 16,),
                                  Text(" Gaandu Kannamma",style: TextStyle(color: Colors.white),),
                                  Text(".Vivek - Mervin",style: TextStyle(color: Colors.white70),),
                                ],
                                ),
...
//tabbar icons
                    TabBar(
                      ...
                      tabs:  [
                        Tab(icon: Icon(Icons.border_all_sharp, color: Colors.white70,size: 30,)),
                        Tab(icon: Icon(Icons.video_collection_outlined, color: Colors.white70,size: 30,)),
                        Tab(icon: Icon(Icons.perm_contact_cal_outlined, color: Colors.white70,size: 30,)),
                      ],
                    ),
                  ),
                ),
...
//bottom icons
        ...
        BottomNavigationBar(
          ...
          type: BottomNavigationBarType.fixed, // Required for more than three items
          items: [
